...
public class PropertiesConfiguration {
    ...
    @Bean
    public Properties consumerHistoryProperties() {
        Properties properties = loadProperties("classpath:kafka/history_event.consumer.properties");
        log.info("Конфигурация history_event.consumer.properties загружена: \t", properties);
        return properties;
    }
